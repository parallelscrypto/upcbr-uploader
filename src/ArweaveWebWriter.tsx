...
import { Textarea, Input, HStack, Text, VStack, useToast, Menu, MenuButton, MenuList, MenuItem, Tooltip } from "@chakra-ui/react";
...
function ArweaveWebWriter() {
  ...
  const updateUploadHTML = (evt: React.BaseSyntheticEvent) => {
    setUploadHTML(evt.target.value);
  };
